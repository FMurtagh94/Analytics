...
To ensure the accuracy of the results, the data was cleaned using the GAD (0-21) and STAI (20-80) score ranges. Any score outside of the screening range were removed. As a result  7 patient responses were excluded, 5 from the Control study and 2 from the Experimental study. 
